...
export const navItems: NavItem[] = [
  { label: "Home", href: "/" },
  { label: "Ask Energy", href: "/ai-assistant" },
  { label: "Articles", href: "/analysis" },
  { label: "Global map", href: "/global-map" },
...
export const focusAreas: FocusArea[] = [
  ...
  { title: "Solar Energy & Green Hydrogen", description: "Exploring Algeria's renewable potential and its role in future Euro-African energy cooperation." },
